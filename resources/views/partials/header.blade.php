    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="/dashboard" class="d-lg-none">
                <img alt="Logo" src="{{ asset('assets/media/img/logo_2.png') }}" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        @can('cashier')
                        <img alt="Logo" src="{{ asset('assets/media/img/cashier.png') }}" />
                        @endcan
                        @can('admin')
                        <img alt="Logo" src="{{ asset('assets/media/img/administrator.png') }}" />
                        @endcan
                    </div>
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    {{-- <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">Cashier</a> --}}
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
