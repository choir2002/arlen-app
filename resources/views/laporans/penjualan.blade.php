                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Nama Kasir</th>
                                <th class="min-w-125px">Diskon</th>
                                <th class="min-w-125px">Uang Tunai</th>
                                <th class="min-w-125px">Kembalian</th>
                                <th class="min-w-125px">Total Belanja</th>
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td>{{ $Lpenjualan->discount }}</td>
                                <td>{{ $Lpenjualan->cash }}</td>
                                <td>{{ $Lpenjualan->return }}</td>
                                <td>{{ $Lpenjualan->subtotal }}</td>
                                <td>{{ $Lpenjualan->total_payment }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                        <!--end::Table body-->
